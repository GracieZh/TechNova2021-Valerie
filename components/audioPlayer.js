/**
 * @flow
 * ADAPTED FROM: https://github.com/expo/playlist-example
 */
 ...
 export default class App extends React.Component {
   ...
   async _loadNewPlaybackInstance(playing) {
     ...
     if (PLAYLIST[this.index].isVideo) {
      ...
      if (this.playbackInstance != null) {
        if(!this.state.playedAlready) {
          this.playbackInstance.playAsync();
          this.setState({ playedAlready: true });
        } else {
   ...
   _onStopPressed = () => {
     if (this.playbackInstance != null) {
       this.playbackInstance.stopAsync();if (this.playbackInstance != null) {
        if (this.state.isPlaying) {
          this.playbackInstance.pauseAsync();
        } else {
          this.playbackInstance.playAsync();
   ...
   render() {
     return !this.state.fontLoaded ? (
       ...
       <View>
         ...
         {this.state.showVideo ? (<View></View>) : null}
       </View>
     );
   }
 }
